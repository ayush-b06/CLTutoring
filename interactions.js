...
function adjustHomepageForMobile() {
    ...
    if (screenWidth <= 600) {
        ...
        text3.innerHTML = 'IN <b id="charlotte">CHARLOTTE.</b>';
        ...
        h3.innerHTML = 'PRIVATE, PERSONALIZED TUTORING FOR STUDENTS IN <b id="charlotte">CHARLOTTE.</b>';
...
function applyStylesOnScroll() {
    ...
    if (isInViewport(body0Seg2Heading)) {
        setTimeout(() => {
