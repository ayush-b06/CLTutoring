...
function adjustHomepageForMobile() {
    ...
    if (screenWidth <= 600) {
        ...
        text1.innerHTML = '<b id="charlotte">NO MATTER </b>WHO YOU ARE,';
        ...
        text2.innerHTML = 'WE HAVE A COURSE FOR<b id="charlotte"> YOU.</b>';
...
const navPhoneItems = document.querySelectorAll('.phone-menu-tools > a, .phone-curriculum-dropdown');
navPhoneItems.forEach(item => {
  // Add hover effect to each item
  item.addEventListener('mouseover', (event) => {
    event.target.style.transform = 'scale(1.10) translateX(2px)';
    document.querySelector('.phone-menu-tools > a:nth-child(2)').style.transform = 'scale(1)';
    document.querySelector('.phone-menu-tools > a:nth-child(2)').style.opacity = '.75';
  });

  item.addEventListener('mouseout', (event) => {
    event.target.style.transform = 'scale(1.0)';
    document.querySelector('.phone-menu-tools > a:nth-child(2)').style.transform = 'scale(1.10) translateX(2px)';
    document.querySelector('.phone-menu-tools > a:nth-child(2)').style.opacity = '1';
  });
...
const navItems = document.querySelectorAll('.nav-tools > a, .curriculum-dropdown');
navItems.forEach(item => {
  // Add hover effect to each item
  item.addEventListener('mouseover', (event) => {
    event.target.style.transform = 'scale(1.05)';
    document.querySelector('.nav-tools .curriculum-dropdown').style.transform = 'scale(1)';
    document.querySelector('.nav-tools .curriculum-dropdown').style.opacity = '.85';
  });

  item.addEventListener('mouseout', (event) => {
    event.target.style.transform = 'scale(1.0)';
    document.querySelector('.nav-tools .curriculum-dropdown').style.transform = 'scale(1.05)';
    document.querySelector('.nav-tools .curriculum-dropdown').style.opacity = '1';
  });
...
body0Workshops.forEach(workshop => {
    workshop.addEventListener('mouseover', () => {
        if (!workshop.classList.contains('coming-soon')) {
            workshop.style.transform = 'translateY(-10px) scale(1.02)';
...
function applyStylesOnScroll() {
    ...
    if (isInViewport(body0Seg1Line, 0)) {
        setTimeout(() => {
    ...
    const teachLine = document.querySelector('.teach-line');
    if (isInViewport(teachLine)) {
        teachLine.style.transform = 'translateY(0) scaleX(1)';
    }
    ...
    const body1Workshops = document.querySelectorAll('.workshops:first-child .workshop-box');
    const body1Workshop1Img= document.querySelector('.workshop-box:first-child .workshop-img');
    const body1Workshops2 = document.querySelectorAll('.workshops:nth-child(2) .workshop-box');
    const body1Workshop2Img= document.querySelector('.workshops:nth-child(2) .workshop-box:first-child .workshop-img');
    ...
    if (isInViewport(body1Workshop1Img, 100)) {
        ...
        body1Workshops[0].style.opacity = '.75';
        setTimeout(() => {
            body1Workshops[2].style.transform = 'translateY(0)';
            body1Workshops[2].style.opacity = '.75';
            setTimeout(() => {
                body1Workshops[1].style.transform = 'translateY(0)';
                body1Workshops[1].style.opacity = '.75';
            }, 100);
        }, 100);
    }
    if (isInViewport(body1Workshop2Img, 100)) {
        body1Workshops2[0].style.transform = 'translateY(0)';
        body1Workshops2[0].style.opacity = '.5';
        setTimeout(() => {
            body1Workshops2[2].style.transform = 'translateY(0)';
            body1Workshops2[2].style.opacity = '.5';
            setTimeout(() => {
                body1Workshops2[1].style.transform = 'translateY(0)';
                body1Workshops2[1].style.opacity = '.75';
            }, 100);
        }, 100);
    }
